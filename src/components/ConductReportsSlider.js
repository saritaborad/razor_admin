...
export default function ConductReportsSlider() {
                        ...
                        <div className="col-12">
                            <div className="main-report-div">
                                <div className="d-sm-flex justify-content-end">
                                    <button type="submit" className="btn-comn-class d-flex align-items-center justify-content-center  me-0 me-sm-4  ">
                                    ...
                                    <button type="button" className="btn-comn-class-black-bdr mt-3 mt-sm-0">
                                        Eliminar comentario
                                    </button>
                                </div>
                                <div className="modal-slide-main d-flex mt-5 row">
                                    <div className="col-lg-4 col-md-4 p-0 ">
                                        <div className="conduct-image position-relative h-100">
                                            <span class="post-viewer-couter d-flex">
                                            ...
                                            <div className="conduct-desc">
                                                <p>
                                                    Oremos por mi hna mayor, por favor, se encuentra distanciada del Señor desde hace muchos años y eso le está pasando la factura. Roguemos por su alma y conversión. Santa María de Nazareth
                                                    rogamos por tu intercesión. Amen .
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="conduct-chat-module ">
                                            <div class="conduct-chat-f-dl mb-4">
                                                ...
                                                <div className="mt-3 report-peofile-txt-bdi">
                                                    <p>
                                                        Mírame con compasión y no me dejes, Madre Mía. ... Animado por esta confianza, vuelo a ti, oh Virgen de las vírgenes, mi madre; A ti vengo, delante de ti estoy, pecaminoso y doloroso.
                                                    </p>
                                                    <p>
                                                        Oh, Madre del Verbo Encarnado, no menosprecies mis peticiones, y en tu misericordia escucha y contesta a lo que te pido. Pido el día de hoy por Luci Alameda, por su pronta
                                                        sanaciónAmen.
                                                    </p>
                                                </div>
                                            </div>
                                            <ul class="conduct-chat-f-dl-inner">
                                                <li className="">
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div className="ms-3">
                                                            <span className="report-peofile-txt">Ronald Borjas</span>
                                                        </div>
                                                        <div className="ms-auto">
                                                            <Dropdown drop="left" className="d-inline-block reports-dropdown">
                                                                <Dropdown.Toggle className="table-dropdown-btn" id="dropdown-basic">
                                                    ...
                                                    <div className="mt-2 report-peofile-txt-bdi">
                                                        <p>Que te pasa en la cabeza, para que publicas esto</p>
                                                    </div>
                                                    <div className="d-flex">
                                                        <span className="desc-text d-flex">1d</span>
                                                        <span className="desc-text d-flex ms-2">
                                                            <img className="me-2" src={Hands} alt="profile" /> Rezar
                                                        </span>
                                                        <span className="desc-text d-flex ms-2">
                                                            <img className="me-2" src={Responder} alt="profile" /> Responder
                                                        </span>
                                                    </div>
                                                </li>
                                                <li className="">
                                                    ...
                                                    <div className="d-flex">
                                                        ...
                                                        <span className="desc-text d-flex ms-2 fw-6"> 2 rezos</span>
                                                        <span className="desc-text d-flex ms-2">
                                                            <img className="me-2" src={Responder} alt="profile" /> Responder
                                                        </span>
                                                    </div>
